#pragma checksum "C:\Users\etec\Documents\AppEcommerce\Views\Admin\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "53d9282f5f337eb733dadbdbc71e8658813cce93"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"53d9282f5f337eb733dadbdbc71e8658813cce93", @"/Views/Admin/Index.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 2 "C:\Users\etec\Documents\AppEcommerce\Views\Admin\Index.cshtml"
...
<div class=""d-xl-flex justify-content-between align-items-start"">
    ...
    <div class=""d-sm-flex justify-content-xl-between align-items-center mb-2"">
        <div class=""btn-group bg-white p-3"" role=""group"" aria-label=""Basic example"">
            ...
            WriteLiteral(@"-link text-light py-0 border-right"">7 Days</button>
                    ...
                    <div class=""col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card"">
                        <div class=""card"">
                            <div class=""card-body text-center"">
                                <h5 class=""mb-2 text-dark font-weight-normal"">Produtos Cadastra");
            WriteLiteral("dos</h5>\r\n                                <h2 class=\"mb-4 text-dark font-weight-bold\">");
#nullable restore
#line 74 "C:\Users\etec\Documents\AppEcommerce\Views\Admin\Index.cshtml"
                                                                       Write(Model.Count());
                    ...
                    <div class=""col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card"">
                        <div class=""card"">
                            <div class=""card-body text-center"">
                                ...
                                <div
        ");
            WriteLiteral(@"                            class=""dashboard-progress dashboard-progress-2 d-flex align-items-center justify-content-center item-parent"">
                    ...
                    <div class=""col-xl-3  col-lg-6 col-sm-6 grid-margin stretch-card"">
                        <div class=""card"">
                            <div class=""card-body text-center"">
                                ...
                                <div
                                    class=""d");
            WriteLiteral(@"ashboard-progress dashboard-progress-3 d-flex align-items-center justify-content-center item-parent"">
                    ...
                    <div class=""col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card"">
                        <div class=""card"">
                            <div class=""card-body text-center"">
                                ...
                                <div
                                    class=""dashboard-progress dashboard-progress-4 d-flex align");
            WriteLiteral(@"-items-center justify-content-center item-parent"">
                        ...
                        <div class=""card"">
                            <div class=""card-body"">
                                <div class=""row"">
                                   ...
                                   ");
            WriteLiteral(@"         <div class=""dropdown dropdown-arrow-none"">
                                    ...
                                    <div class=""col-lg-3 col-sm-4 grid-margin  grid-margin-lg-0"">
                                        <div class=""wrapper pb-5 border-bottom"">
                                            <div
                                                ...
                                                <span class=""text-success""><i class");
            WriteLiteral(@"=""mdi mdi-arrow-up""></i>2.95%</span>
                                            </div>
                                        ...
                                        <div class=""pl-0 pl-lg-4 "">
                                            <div class=""d-xl-flex justify-content-between align-items-center mb-2"">
                                                ...
                                                <div class=""d-lg-flex"">
                                                    ...
                                                    <p class=""text");
            WriteLiteral(@"-dark font-weight-bold mb-0"">GMT-0400 Eastern
                                                        Delight Time</p>
                                                </div>
                                            </div>
                    ...
                    <div class=""col-sm-4 grid-margin stretch-card"">
                        <div class=""card card-danger-gradient"">
                            <div class=""card-body mb-4"">
                                <h4 class=""card-title text-white"">Acco");
            WriteLiteral(@"unt Retention</h4>
